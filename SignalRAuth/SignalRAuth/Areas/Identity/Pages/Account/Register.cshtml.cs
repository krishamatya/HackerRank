...
namespace SignalRAuth.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<SignalRAuthUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new SignalRAuthUser { FirstName= Input.FirstName,LastName= Input.LastName,UserName = Input.Email, Email = Input.Email };
